...
-- Concept Used : Window Function (ROW_NUMBER + PARTITION BY)
-- =============================================================
...
-- Output:
-- Orders ranked within each customer group.

-- Business Insight:
-- Rank 1 represents the highest-value order of each customer.
...
-- Output:
-- Top 3 customers displayed.

-- Business Insight:
-- These customers generated the highest revenue and
-- can be considered the most valuable customers.
